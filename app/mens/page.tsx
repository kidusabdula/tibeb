...
export default async function MensPage() {
  ...
  const { data: categoriesData } = await supabase
    .rpc('get_subcategories', { category_name: 'mens' });
...
export const metadata = {
  ...
  description: 'Discover our collection of traditional Habesha men&apos;s clothing, perfect for cultural events and celebrations.',
};
